...
public final class Spaceship extends Rescuer implements IDrawable{
	...
	public String toString(){return "Spaceship: loc="+this.getLocationX()+","+this.getLocationY()+" color = ["+ColorUtil.red(getColor()) + "," + ColorUtil.green(getColor())+","+ColorUtil.blue(getColor())+"] size="+this.getSize();}
	
	public void moveLeft(){this.setLocationX(getLocationX()-10);}
	
	public void moveRight(){this.setLocationX(getLocationX()+10);}
	
	public void moveUp(){this.setLocationY(getLocationY()+10);}
	
	public void moveDown(){this.setLocationY(getLocationY()-10);}
	...
	boolean collidesWith(GameObject otherObject) {return false;}
}
